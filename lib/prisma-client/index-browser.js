...
exports.Prisma.BookCirculationScalarFieldEnum = {
  id: 'id',
  bookId: 'bookId',
  studentId: 'studentId',
...
exports.Prisma.MedicalInventoryScalarFieldEnum = {
  id: 'id',
  name: 'name',
  stock: 'stock',
  unit: 'unit'
...
exports.CirculationStatus = exports.$Enums.CirculationStatus = {
  BORROWED: 'BORROWED',
  RETURNED: 'RETURNED',
  OVERDUE: 'OVERDUE'
};
