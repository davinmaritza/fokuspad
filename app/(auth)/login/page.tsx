        ...
        >
          ...
          <form onSubmit={handleLogin} className="space-y-6">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-3 gap-2.5">
              <Button type="button" variant="outline" className="h-9 text-[10px] font-bold border-[#E2E8F0] hover:border-[#1E293B] hover:bg-white text-slate-700 hover:text-[#1E293B] rounded-lg transition-all duration-200 hover:-translate-y-0.5 hover:shadow-sm active:scale-[0.97]" onClick={() => { setLoginType('user'); setEmail('admin@demo.com'); setPassword('password123'); }}>Admin</Button>
              <Button type="button" variant="outline" className="h-9 text-[10px] font-bold border-[#E2E8F0] hover:border-[#1E293B] hover:bg-white text-slate-700 hover:text-[#1E293B] rounded-lg transition-all duration-200 hover:-translate-y-0.5 hover:shadow-sm active:scale-[0.97]" onClick={() => { setLoginType('user'); setEmail('guru@demo.com'); setPassword('password123'); }}>Guru</Button>
              <Button type="button" variant="outline" className="h-9 text-[10px] font-bold border-[#E2E8F0] hover:border-[#1E293B] hover:bg-white text-slate-700 hover:text-[#1E293B] rounded-lg transition-all duration-200 hover:-translate-y-0.5 hover:shadow-sm active:scale-[0.97]" onClick={() => { setLoginType('user'); setEmail('pelatih@demo.com'); setPassword('password123'); }}>Pelatih</Button>
              <Button type="button" variant="outline" className="h-9 text-[10px] font-bold border-[#E2E8F0] hover:border-[#1E293B] hover:bg-white text-slate-700 hover:text-[#1E293B] rounded-lg transition-all duration-200 hover:-translate-y-0.5 hover:shadow-sm active:scale-[0.97]" onClick={() => { setLoginType('user'); setEmail('siswa@demo.com'); setPassword('password123'); }}>Siswa</Button>
              <Button type="button" variant="outline" className="h-9 text-[10px] font-bold border-[#E2E8F0] hover:border-[#1E293B] hover:bg-white text-slate-700 hover:text-[#1E293B] rounded-lg transition-all duration-200 hover:-translate-y-0.5 hover:shadow-sm active:scale-[0.97] col-span-2 lg:col-span-1" onClick={() => { setLoginType('parent'); setEmail('ortu@demo.com'); setPassword('password123'); }}>Orang Tua</Button>
            </div>
